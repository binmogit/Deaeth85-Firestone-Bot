...
Gui Add, Text, x0 y100 w900 h30 +0x200 +Center, -INSTRUCTIONS-
Gui Font, s9 Bold, Tahoma
Gui Add, Text, x0 y130 w900 h30 +0x200 +Center, Set Display to: 1920x1080 Maximized (NOT Fullscreen)
Gui Add, Text, x0 y160 w900 h30 +0x200 +Center, (Recommended) Set Hero Upgrade to Milestone
Gui Add, Text, x0 y190 w900 h30 +0x200 +Center, Make sure you start on main page
Gui Add, Text, x0 y220 w900 h30 +0x200 +Center, Please check the rest of the tabs for specific script options
Gui Add, Text, x0 y250 w900 h30 +0x200 +Center, Personal Tree tab you can select upgrades to have the script purchase for you
Gui Font, s15, Bold, Tahoma
Gui Add, Text, x0 y280 w900 h30 +0x200 +Center, -NOTES-
Gui Font, s9 Bold, Tahoma
Gui Add, Text, x0 y310 w900 h30 +0x200 +Center, The script takes control of your mouse and will repeat until you close it
Gui Add, Text, x0 y340 w900 h30 +0x200 +Center, You have a 1 minute delay after the Hero Upgrade section to use your mouse w/o risk until script starts over
Gui Add, Text, x0 y370 w900 h30 +0x200 +Center, Credit to @Dandey for the original code
Gui Add, Picture, x420 y430 w60 h60, Images\giftbox.png
...
Gui Font, s9 Bold, Tahoma
Gui Add, Checkbox, x10 y60 w400 h30 vToken Checked%Token%, Use Tavern Tokens/Craft Artifact (Will NOT work if Skip Claiming Beer selected in QoL section)
Gui Add, Checkbox, x10 y90 w400 h30 vSellEx Checked%SellEx%, Open Exotic Merchant (Master toggle that only goes to Exotic Merchant)
Gui Add, Radio, x20 y120 w400 h30 vSellScrolls Checked%SellScrolls%,  1. Sell ONLY Exotic Scrolls
Gui Add, Radio, x20 y150 w400 h30 vSellNoGold Checked%SellNoGold%, 2. Sell All But Gold Items
Gui Add, Radio, x20 y180 w400 h30 vSellAll Checked%SellAll%,  3. Sell All Exotic Items
...
Gui Add, Checkbox, x10 y300 w400 h30 vChests Checked%Chests%, Open Chests - Choose an "Exclude from" option from the dropdowns below - Gifts will be opened as well
Gui Add, DropDownList, x10 y330 w190 r5 vGearChestExclude, Exclude All|Don't Exclude Any|Epic and Higher|Legendary and Higher|Mythic||
Gui Add, DropDownList, x210 y330 w190 r5 vJewelChestExclude, Exclude All|Don't Exclude Any|Diamond and Higher||Opal and Higher|Emerald
Gui Add, Checkbox, x10 y360 w400 h30 vBless Checked%Bless%, Upgrade Blessings - Will open Oracle chests even without Open Chests selected
Gui Add, Checkbox, x10 y390 w190 h30 vDaily Checked%Daily%, Claim Daily Quests
Gui Add, Checkbox, x210 y390 w190 h30 vWeekly Checked%Weekly%, Claim Weekly Quests
Gui Add, Checkbox, x10 y420 w190 h30 vEvents Checked%Events%, Claim Basic Events
Gui Add, Checkbox, x210 y420 w190 h30 vMail Checked%Mail%, Check Mail
Gui Add, Checkbox, x10 y450 w190 h30 vAwaken Checked%Awaken%, Awaken Heroes
Gui Add, Checkbox, x210 y450 w190 h30 vCrystal Checked%Crystal%, Spend Pickaxes on Crystal
Gui Add, Checkbox, x10 y480 w400 h30 vPTree Checked%PTree%, Upgrade Personal Tree (Select options on next tab if upgrading)
...
;Gui Add, Picture, x0 y300 w900 h300, Images\dragonbanner.png
Gui Add, Picture, x450 y420 w300 h300, Images\dragon.png
Gui Font, s15, Bold, Tahoma
Gui Add, Text, x0 y30 w900 h30 +0x200 +Center, Rarer Options
Gui Font, s9 Bold, Tahoma
Gui Add, Checkbox, x10 y60 w600 h30 vBeer Checked%Beer%, Skip Claiming Beer
Gui Add, Checkbox, x10 y90 w400 h30 vNoGuild Checked%NoGuild%, Skip All Guild Functions
Gui Add, Checkbox, x10 y120 w400 h30 vNoEng Checked%NoEng%, Skip Engineer
Gui Add, Checkbox, x10 y150 w400 h30 vPickaxes Checked%Pickaxes%, Skip Claiming Pickaxes
Gui Add, Checkbox, x10 y180 w400 h30 vGNotif Checked%GNotif%, Clear Annoying Guild Notifications
Gui Add, Checkbox, x10 y210 w200 h30 vAlch Checked%Alch%, Skip Alchemy
Gui Add, Checkbox, x10 y240 w200 h30 vDust Checked%Dust%, Don't Use Dust in Alchemy
Gui Add, Checkbox, x10 y270 w400 h30 vCoin Checked%Coin%, Use Exotic Coins in Alchemy
Gui Add, Checkbox, x10 y300 w400 h30 vResearch Checked%Research%, Skip Research
Gui Add, Checkbox, x10 y330 w400 h30 vSkipOracle Checked%SkipOracle%, Skip Oracle
Gui Add, Checkbox, x10 y360 w400 h30 vNoHero Checked%NoHero%, Don't Upgrade Heroes
Gui Add, Checkbox, x10 y390 w500 h30 vDisableWarning Checked%DisableWarning%, Do not show Steam warning again. (Popup when starting script)
...
Gui Font, s15, Bold, Tahoma
Gui Add, Text, BackgroundTrans x0 y30 w900 h30 +0x200 +Center, Press START down below to run the Script
Gui Font, s9 Bold, Tahoma
Gui Add, Text, BackgroundTrans x0 y60 w900 h30 +0x200 +Center, Pressing Esc at any time will stop the Script
Gui Add, Text, x0 y90 w900 h30 +0x200 +Center, Thank you for using my bot
Gui Add, Text, x0 y120 w900 h30 +0x200 +Center, Donations are never required, but accepted through Venmo:
Gui Add, Text, x0 y150 w900 h30 +0x200 +Center, @Spyder85
Gui Add, Button, x100 y180 w300 h60 gSaveSettings, Save GUI Settings
Gui Add, Button, x500 y180 w300 h60 +0x200 +Center gButtonStart, Start Script
Gui Add, Picture, x0 y240 w900 h180, Images\fslogo.png
Gui Add, Picture, x0 y420 w900 h180, Images\logo.png
...
Gui Show, w900 h600, Deaeth85's Firestone Bot - V2.2.9
